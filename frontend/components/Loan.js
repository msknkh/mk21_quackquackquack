            ...
            <Container>
                ...
                <View style={styles.content} >
                    ...
                    <View style={{ flex: 4.5, marginBottom:10 }}>
                            ...
                            <TouchableOpacity onPress={() => this.getNearbyPlaces('Mudra')} style={[styles.button, { backgroundColor: '#479689' }]}>
                              <View style={{ flexDirection: 'row' }}>
                                <View style = {styles.buttonTextContainer, {
                                  ...
                                  <Text style={styles.buttonText, {fontSize:30, color: 'white', textAlign:'center'}}>MUDRA</Text>
                                  <Text style={styles.buttonText}></Text>
                                </View>
                                ...
                                <View style = {styles.buttonTextContainer}>
                                  ...
                                  <Text style={styles.buttonText}>Mudra Yojana</Text>
                                  <Text style={styles.buttonText}>(PMMY/MUDRA)</Text>
                            ...
                            <TouchableOpacity onPress={() => this.getNearbyPlaces('StandUp')} style={[styles.button, { backgroundColor: '#2295f3' }]}>
                              <View style={{ flexDirection: 'row' }}>
                                <View style = {styles.buttonTextContainer, {
                                  flex:3.1,
                                  borderColor: 'white',
                                  ...
                                  <Text style={styles.buttonText}></Text>
                                  <Text style={styles.buttonText, {fontSize:30, color: 'white', textAlign:'center'}}>SUI</Text>
                                  <Text style={styles.buttonText}></Text>
                                </View>

                                <View style = {styles.buttonTextContainer}>

                                  <Text style={styles.buttonText}>Stand Up</Text>
                                  <Text style={styles.buttonText}>India</Text>
                                </View>
                              </View>
                            </TouchableOpacity>
